...
- context_overlap (1-10): Domain alignment — score highly if the candidate's skills are transferable to this company's domain, even if not an exact match. Enterprise SaaS, B2B, payments, and platform products count as strong overlap with the candidate's background.
